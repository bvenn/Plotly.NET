...
<div id="f70f937b-8f76-4b60-abf1-7fdecdd69fbb" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_f70f937b8f764b60abf17fdecdd69fbb = function() {
            ...
            var config = {};
            Plotly.newPlot('f70f937b-8f76-4b60-abf1-7fdecdd69fbb', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_f70f937b8f764b60abf17fdecdd69fbb();
                };

...
<div id="a4a3f2c5-f7a3-4f69-b964-727ea08edd82" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_a4a3f2c5f7a34f69b964727ea08edd82 = function() {
            ...
            var config = {};
            Plotly.newPlot('a4a3f2c5-f7a3-4f69-b964-727ea08edd82', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_a4a3f2c5f7a34f69b964727ea08edd82();
                };

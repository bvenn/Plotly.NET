...
<div id="fd7841e4-e060-4fb6-b1e3-41db65583da3" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_fd7841e4e0604fb6b1e341db65583da3 = function() {
            ...
            var config = {};
            Plotly.newPlot('fd7841e4-e060-4fb6-b1e3-41db65583da3', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_fd7841e4e0604fb6b1e341db65583da3();
                };
